        ...
        !function (e, t) {
            ...
            return function (e) {
                ...
                function f(e, t, n) {
                    ...
                    S += (w + b) % 7 ? 7 : 0;
                    for (var M = 1; M <= S; M++) {
                        var E = (M - 1) % 7, x = d[E], C = M - (w >= 0 ? w : 7 + w), L = new Date(r, a, C), Y = f[+L],
                            j = C < 1 || C > b, O = j ? C < 1 ? -1 : 1 : 0, P = j && !l, k = P ? "" : L.getDate(),
                            N = +L == +i, _ = E === h[0] || E === h[1], I = m !== y, A = "qs-square " + x;
                ...
                t.default = function (e, t) {
                    var n = function (e, t) {
                        ...
                        var m = u === document.body, y = n ? u.parentElement || n : m ? document.body : u.parentElement,
